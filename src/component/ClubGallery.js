...
import moments from "../data/momentsData.js";
// Icon import
    ...
    <section className="py-24 w-full bg-[#1a0e2e]">
      <div className="container mx-auto text-center px-4">
        ...
        <p className="text-lg text-gray-400 max-w-3xl mx-auto mb-16">
          A glimpse into the life, events, and achievements of the InQuizitive
          Club.
        </p>
      </div>
            ...
            <SwiperSlide key={index} className="group">
              ...
              <div className="relative w-full aspect-[4/3] rounded-2xl overflow-visible">
                <img
                  src={moment.image}
                  alt={moment.title}
                  className="w-full h-full object-cover rounded-2xl transition-all duration-500 group-[.swiper-slide-active]:grayscale-0 grayscale opacity-50 group-[.swiper-slide-active]:opacity-100"
                />
              ...
              <div className="absolute top-full left-0 w-full h-2/3 mt-2 bg-transparent overflow-hidden transition-opacity duration-500 opacity-0 group-[.swiper-slide-active]:opacity-100">
                <img
                  src={moment.image}
                  alt=""
                  className="w-full h-full object-cover rounded-2xl transform -scale-y-100"
                />
